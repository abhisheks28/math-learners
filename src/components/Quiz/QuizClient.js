...
const QuizClient = () => {
    ...
    const getChildName = () => {
        ...
        // Check from userData/AuthContext for the specific child
        ...
        // Return empty string if the current child doesn't have a name
        // This ensures the name modal appears for children without names
        return "";
    };
